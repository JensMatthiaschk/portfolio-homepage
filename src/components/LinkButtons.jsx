        ...
        <>
            <div className={
                ...
                <ul className={currentTheme === 'dark' ? "text-[var(--dm-secondary-color)]" : "text-[var(--lm-secondary-color)]"} >
                    <li className={currentTheme === 'dark' ? "hover:text-[var(--dm-third-color)] w-7 my-3 ease-in-out delay-100 duration-300" : "w-7 my-3 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_7px_var(--lm-third-color)] transform-gpu"}>
