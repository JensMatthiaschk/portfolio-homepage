...
export default function LinkButtons() {
    ...
    const { currentTheme, sectionActive } = useContext(ThemeContext)

    // useEffect(() => {
    //     if (sectionActive === 'Contact') {
    //         document.querySelector('.linkButtons').classList.toggle("linkButton-fade-out-animation");
    //     }
    // }, [sectionActive])

    return (
        <>
            <div className={`${sectionActive === 'Contact' ? "linkButton-fade-out-animation linkButtons sm:flex flex-col items-start justify-center h-screen fixed mx-5 sm:transition-all z-30 hidden" : "linkButtons sm:flex flex-col items-start justify-center h-full fixed mx-5 sm:transition-all hidden"}`}>
                <ul className={currentTheme === 'dark' ? "z-40 text-[var(--dm-secondary-color)] " : "z-40 text-[var(--lm-secondary-color)] "} >
                    <li className={currentTheme === 'dark' ? "hover:text-[var(--dm-third-color)]" : ""}>
                        <a href="https://github.com/JensMatthiaschk"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor"
                                // className={currentTheme === 'dark' ? "bi bi-github w-6 hover:w-8 my-3 hover:my-0 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_5px_var(--dm-third-color)]" : "bi bi-github w-6 hover:w-8 my-3 hover:my-0 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_7px_var(--lm-third-color)]"}
                                className={currentTheme === 'dark' ? "bi bi-github w-7 my-3 ease-in-out delay-100 duration-300" : "bi bi-github w-7 my-3 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_7px_var(--lm-third-color)]"}
                                viewBox="0 0 16 16">
                    ...
                    <li className={currentTheme === 'dark' ? "hover:text-[var(--dm-third-color)]" : ""}>
                        <a href="http://www.linkedin.com/in/jensmatthiaschk"
                            ...
                            rel="noopener">
                            <svg
                                className={currentTheme === 'dark' ? "bi bi-linkedin w-7 my-3 ease-in-out delay-100 duration-300" : "bi bi-linkedin w-7 my-3 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_7px_var(--lm-third-color)]"}
                                viewBox="0 0 48 48"
                                fill="currentColor"
                    ...
                    <li className={currentTheme === 'dark' ? "hover:text-[var(--dm-third-color)]" : ""}>
                        <label htmlFor="emailModal">
                            <svg
                                className={currentTheme === 'dark' ? "bi bi-envelope-fill w-7 my-3 ease-in-out delay-100 duration-300" : "bi bi-envelope-fill w-7 my-3 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_7px_var(--lm-third-color)]"}
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li
                        className={currentTheme === 'dark' ? "hover:text-[var(--dm-third-color)] w-7 my-3 ease-in-out delay-100 duration-300" : "hover:drop-shadow-[0_0_7px_var(--lm-third-color)] w-7 ease-in-out delay-100 duration-300"}>
