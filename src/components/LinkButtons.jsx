            ...
            <div className={
                sectionActive === 'Contact' && contactVisitedDark === 0 && currentTheme === 'dark' ? "linkButton-fade-out-animation sm:flex flex-col items-start justify-center h-full fixed mx-5 sm:transition-all z-30" :
                    sectionActive === 'Contact' && contactVisitedLight === 0 && currentTheme === 'light' ? "linkButton-fade-out-animation sm:flex flex-col items-start justify-center h-full fixed mx-5 sm:transition-all z-30" :
                        sectionActive === 'Contact' && contactVisitedDark !== 0 && currentTheme === 'dark' ? "fade-out sm:flex flex-col items-start justify-center h-full fixed mx-5 sm:transition-all" :
                            sectionActive === 'Contact' && contactVisitedLight !== 0 && currentTheme === 'light' ? "fade-out sm:flex flex-col items-start justify-center h-full fixed mx-5 sm:transition-all" :
                                "sm:flex flex-col items-start justify-center h-full fixed mx-5 sm:transition-all"
            }>
