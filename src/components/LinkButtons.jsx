                ...
                <ul className="h-fit z-40">
                    <li>
                        <a href="https://github.com/JensMatthiaschk"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor"
                                className={currentTheme === 'dark' ? "bi bi-github w-6 hover:w-8 my-3 hover:my-0 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_5px_#275e74]" : "bi bi-github w-6 hover:w-8 my-3 hover:my-0 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_7px_var(--lm-third-color)]"}
                                viewBox="0 0 16 16">
                    ...
                    <li>
                        <a href="http://www.linkedin.com/in/jensmatthiaschk"
                            ...
                            rel="noopener">
                            <svg
                                className={currentTheme === 'dark' ? "bi bi-linkedin w-6 hover:w-8 my-3 hover:my-0 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_5px_#275e74]" : "bi bi-linkedin w-6 hover:w-8 my-3 hover:my-0 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_7px_var(--lm-third-color)]"}
                                viewBox="0 0 48 48"
                                fill="currentColor"
                    ...
                    <li>
                        <label htmlFor="emailModal">
                            <svg
                                className={currentTheme === 'dark' ? "bi bi-envelope-fill w-6 hover:w-8 my-3 hover:my-0 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_5px_#275e74]" : "bi bi-envelope-fill w-6 hover:w-8 my-3 hover:-mt-[0.2rem] ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_7px_var(--lm-third-color)]"}
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li
                        className={currentTheme === 'dark' ? "hover:drop-shadow-[0_0_5px_#275e74] w-6 hover:w-8 my-3 hover:my-0 ease-in-out delay-100 duration-300" : "hover:drop-shadow-[0_0_7px_var(--lm-third-color)] w-6 hover:w-8 hover:my-0 ease-in-out delay-100 duration-300"}>
