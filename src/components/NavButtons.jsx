                        ...
                        <li key={i}>
                            <Link onClick={() => setSectionActive(dot.section)} to={dot.section} spy={true} smooth={true} offset={dot.offset} duration={500}>
                                <div className="text-transparent hover:text-[var(--dm-secondary-color)] flex items-center">
                                    ...
                                    <div className={`${sectionActive === dot.section ? "flex justify-end w-[0.8rem] h-[0.8rem] rounded-full bg-[var(--dm-secondary-color)] ease-in-out delay-100 duration-300 border-[1.5px] border-solid border-[var(--dm-secondary-color)] -mr-[0.1rem] text-transparent hover:text-[var(--dm-secondary-color)]"
