...
export default function Projects() {
    ...
    return (
        <>
            <section id="Projects" ref={projectsRef} className="flex flex-col h-fit transition-all justify-evenly items-center sm:mx-16">
                ...
                <div ref={cardRef} className={cardIsVisible ? "fade-in flex flex-col h-full w-full sm:mt-20 mt-3 pb-20 px-4 items-center sm:gap-y-16" : "flex flex-col h-full w-full sm:mt-20 mt-3 pb-20 sm:mx-10 px-4 items-center gap-y-16 invisible"}>
                                    ...
                                    <div key={i} className={currentTheme === "dark" ? "card w-80 h-fit border-cyan-900 border-solid border-2 bg-[var(--dm-glow-color)] hover:shadow-[0_5px_8px_2px_var(--dm-third-color)] rounded-md ease-in-out delay-50 duration-200"
                                        ...
                                        <div className="card-body flex flex-col justify-between p-5">
                                            ...
                                            <div className="flex gap-x-1 items-center mt-1 h-4">
                                                ...
                                                {p.page_url ? <a href={p.repo_url ? p.repo_url : ""}
                                                    target="_newBrowserTab"
                                                    rel="noopener">
                                                    <svg className="w-5 hover:w-6 h-5 hover:h-6 ease-in-out delay-100 duration-300"
                                                        fill="currentColor"
