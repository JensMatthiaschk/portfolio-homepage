    ...
    return (
        <>
            <section id="Contact" ref={drawingRef} className="flex flex-col justify-between h-screen lg:mx-10 soverflow-hidden">
                <div ref={contactRef} className={contactIsVisible ? "fade-in sm:mt-20 mt-12 sm:ml-10 px-10 sm:text-2xl text-md font-['Montserrat'] text-center font-medium" : "sm:mt-20 mt-12 sm:ml-10 px-10 sm:text-2xl text-xl font-['Montserrat'] invisible text-right font-medium"}>
                    <span className="mr-2 w-fit">If you have a question, an exciting project or just want to talk about</span>
                    <div className={currentTheme === "dark" ? "badge font-extrabold lg:text-2xl text-sm md:p-4 p-2 md:m-2 m-1 sm:badge-lg badge-sm badge-outline w-fit uppercase hover:text-[var(--dm-third-color)]" : "badge font-extrabold lg:text-2xl text-sm md:p-4 p-2 md:m-2 m-1 sm:badge-lg badge-sm badge-outline w-fit uppercase hover:text-[var(--lm-third-color)]"}>Full-Stack Development</div>
                    <div className={currentTheme === "dark" ? "badge font-extrabold lg:text-2xl text-sm md:p-4 p-2 md:m-2 m-1 sm:badge-lg badge-sm badge-outline w-fit uppercase hover:text-[var(--dm-third-color)]" : "badge font-extrabold lg:text-2xl text-sm md:p-4 p-2 md:m-2 m-1 sm:badge-lg badge-sm badge-outline w-fit uppercase hover:text-[var(--lm-third-color)]"}>UI/UX Design</div>
                    <div className={currentTheme === "dark" ? "badge font-extrabold lg:text-2xl text-sm md:p-4 p-2 md:m-2 m-1 sm:badge-lg badge-sm badge-outline w-fit uppercase hover:text-[var(--dm-third-color)]" : "badge font-extrabold lg:text-2xl text-sm md:p-4 p-2 md:m-2 m-1 sm:badge-lg badge-sm badge-outline w-fit uppercase hover:text-[var(--lm-third-color)]"}>Start-Up</div>
                    <div className={currentTheme === "dark" ? "badge font-extrabold lg:text-2xl text-sm md:p-4 p-2 md:m-2 m-1 sm:badge-lg badge-sm badge-outline w-fit uppercase hover:text-[var(--dm-third-color)]" : "badge font-extrabold lg:text-2xl text-sm md:p-4 p-2 md:m-2 m-1 sm:badge-lg badge-sm badge-outline w-fit uppercase hover:text-[var(--lm-third-color)]"}>Random tech topics</div>
                    <div className={currentTheme === "dark" ? "badge font-extrabold lg:text-2xl text-sm md:p-4 p-2 md:m-2 m-1 sm:badge-lg badge-sm badge-outline w-fit uppercase hover:text-[var(--dm-third-color)]" : "badge font-extrabold lg:text-2xl text-sm md:p-4 p-2 md:m-2 m-1 sm:badge-lg badge-sm badge-outline w-fit uppercase hover:text-[var(--lm-third-color)]"} >Burgers</div>
                    <div className={currentTheme === "dark" ? "badge font-extrabold lg:text-2xl text-sm md:p-4 p-2 md:m-2 m-1 sm:badge-lg badge-sm badge-outline w-fit uppercase hover:text-[var(--dm-third-color)]" : "badge font-extrabold lg:text-2xl text-sm md:p-4 p-2 md:m-2 m-1 sm:badge-lg badge-sm badge-outline w-fit uppercase hover:text-[var(--lm-third-color)]"}>Cocktail Recipes</div>
