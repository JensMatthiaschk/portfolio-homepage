...
export default function Contact() {
    ...
    const { ref: contactRef, inView: contactIsVisible } = useInView({ threshold: 0.25 });
    ...
    return (
        <>
            <section id="Contact" className="flex flex-col lg:mx-10">
                <div ref={contactRef} className={contactIsVisible ? "fade-in sm:mt-20 my-12 sm:ml-10 px-10 sm:text-2xl text-md font-['Montserrat'] text-center font-medium lg:w-[70%] lg:mx-auto" : "sm:mt-20 mt-12 sm:ml-10 px-10 sm:text-2xl text-xl font-['Montserrat'] invisible text-right font-medium"}>
                    ...
                    <div className={currentTheme === "dark" ? "badge font-extrabold lg:text-2xl text-sm md:p-4 p-2 md:m-2 m-1 sm:badge-lg badge-sm badge-outline w-fit uppercase hover:text-[var(--dm-third-color)] ease-in-out delay-50 duration-300" : "badge font-extrabold lg:text-2xl text-sm md:p-4 p-2 md:m-2 m-1 sm:badge-lg badge-sm badge-outline w-fit uppercase hover:text-[var(--lm-third-color)] ease-in-out delay-50 duration-300"}><p className="w-fit px-2 ease-in-out delay-100 duration-300"> UX/UI </p> Design</div>
                    <div className={currentTheme === "dark" ? "badge font-extrabold lg:text-2xl text-sm md:p-4 p-2 md:m-2 m-1 sm:badge-lg badge-sm badge-outline w-fit uppercase hover:text-[var(--dm-third-color)] ease-in-out delay-50 duration-300" : "badge font-extrabold lg:text-2xl text-sm md:p-4 p-2 md:m-2 m-1 sm:badge-lg badge-sm badge-outline w-fit uppercase hover:text-[var(--lm-third-color)] ease-in-out delay-50 duration-300"}>Start-Up</div>
                ...
                <div className="flex justify-between">
                    {drawingIsVisible &&
                        <div className="flex flex-col h-[24rem] sm:h-[30rem] justify-between pb-5 sm:pb-10 sm:pt-32">
                            <ul className={(currentTheme === 'dark' && contactVisitedDark === 0) || (currentTheme === 'light' && contactVisitedLight === 0) ? "linkButton-fade-in-animation flex flex-col md:flex-row sm:flex-wrap gap-4 sm:gap-6 items-start sm:pl-16 pl-14 z-30" : "fade-in flex flex-col md:flex-row sm:flex-wrap gap-4 sm:gap-6 items-start sm:pl-16 pl-14 z-30"}>
                                <li>
                                    <a href="https://github.com/JensMatthiaschk"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            fill="currentColor"
                                            className={currentTheme === 'dark' ? "bi bi-github w-14 hover:w-16 hover:-m-1 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_10px_#275e74]" : "bi bi-github w-14 hover:w-16 hover:-m-1 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_7px_var(--lm-third-color)]"}
                                            viewBox="0 0 16 16">
                                ...
                                <li>
                                    <a href="http://www.linkedin.com/in/jensmatthiaschk"
                                        target="_newBrowserTab"
                                        rel="noopener">
                                        <svg className={currentTheme === 'dark' ? "bi bi-linkedin w-14 hover:w-16 hover:-m-1 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_10px_#275e74]" : "bi bi-linkedin w-14 hover:w-16 hover:-m-1 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_7px_var(--lm-third-color)]"}
                                            viewBox="0 0 48 48"
                                            fill="currentColor"
                                ...
                                <li>
                                    <label htmlFor="emailModal">
                                        <svg version="1.1"
                                            id="Capa_1"
                                            className={currentTheme === 'dark' ? "bi bi-envelope-fill w-14 hover:w-16 hover:-m-1 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_10px_#275e74]" : "bi bi-envelope-fill w-14 hover:w-16 hover:-m-1 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_7px_var(--lm-third-color)]"}
                                            xmlns="http://www.w3.org/2000/svg"
					...
					V23c0-1.104,0.896-2,2-2h28c1.104,0,2,0.896,2,2V41z"/>
                                ...
                                <li className={currentTheme === 'dark' ? "hover:drop-shadow-[0_0_10px_#275e74] w-14 hover:w-16 hover:-m-1 ease-in-out delay-100 duration-300" : "hover:drop-shadow-[0_0_7px_var(--lm-third-color)] w-14 hover:w-16 hover:-m-1 ease-in-out delay-100 duration-300"}>
                    ...
                    <div ref={drawingRef} className="flex relative h-[24rem] sm:h-[30rem]">
                        {(contactVisitedDark === 0 && currentTheme === 'dark' && drawingIsVisible) || (contactVisitedLight === 0 && currentTheme === 'light' && drawingIsVisible) ?
                            <>
                                <div
                                    className={currentTheme === 'dark' ? 'glow-animation absolute sm:bottom-[14rem] bottom-[8rem] right-[6rem] sm:right-[11rem] sm:w-[8rem] w-[3rem] sm:h-[8rem] h-[3rem] rounded-full bg-[var(--dm-glow-color)] sm:shadow-[0_0_140px_130px_var(--dm-glow-color)] shadow-[0_0_90px_70px_var(--dm-glow-color)]' : 'glow-animation absolute sm:bottom-[14rem] bottom-[8rem] right-[7rem] sm:right-[14rem] sm:w-[8rem] w-[3rem] sm:h-[8rem] h-[3rem] rounded-full bg-[var(--lm-glow-color)] sm:shadow-[0_0_140px_130px_var(--lm-glow-color)] shadow-[0_0_90px_70px_var(--lm-glow-color)]'}
                                ></div>
                            ...
                            <>
                                <div
                                    className={currentTheme === 'dark' ? 'glow-fade-in absolute sm:bottom-[14rem] bottom-[8rem] right-[6rem] sm:right-[11rem] sm:w-[8rem] w-[3rem] sm:h-[8rem] h-[3rem] rounded-full bg-[var(--dm-glow-color)] sm:shadow-[0_0_140px_130px_var(--dm-glow-color)] shadow-[0_0_90px_70px_var(--dm-glow-color)]' : 'glow-fade-in absolute sm:bottom-[14rem] bottom-[8rem] right-[7rem] sm:right-[14rem] sm:w-[8rem] w-[3rem] sm:h-[8rem] h-[3rem] rounded-full bg-[var(--lm-glow-color)] sm:shadow-[0_0_140px_130px_var(--lm-glow-color)] shadow-[0_0_90px_70px_var(--lm-glow-color)]'}
                                ></div>
                    ...
                    {/* <div className="flex absolute right-0 bottom-0 w-[50%]">
                            {(contactVisitedDark === 0 && currentTheme === 'dark') || (contactVisitedLight === 0 && currentTheme === 'light') ?
                                ...
                                <>
                                    <div
                                        className={currentTheme === 'dark' ? 'glow-animation sm:w-[8rem] w-[3rem] sm:h-[8rem] h-[3rem] relative rounded-full bg-[var(--dm-glow-color)] sm:shadow-[0_0_140px_130px_var(--dm-glow-color)] shadow-[0_0_90px_70px_var(--dm-glow-color)]'
                                            : 'glow-animation sm:w-[8rem] w-[3rem] sm:h-[8rem] h-[3rem] absolute sm:mr-44 mr-24 sm:mb-48 mb-32 rounded-full bg-[var(--lm-glow-color)] sm:shadow-[0_0_140px_130px_var(--lm-glow-color)] shadow-[0_0_90px_70px_var(--lm-glow-color)]'}
                                    ></div>
                                    <img className={currentTheme === 'dark' ? "portrait-animation sm:h-[24rem] h-[12rem] z-10"
                                        : "portrait-animation sm:h-[24rem] h-[12rem] z-10 absolute sm:mr-5 mr-2"}
                                        src={portraitSource} alt="PortraitDarkmode" />
                                </>
                                :
                                drawingIsVisible &&
                                <>
                                    <div
                                        className={currentTheme === 'dark' ? 'glow-fade-in sm:w-[8rem] w-[3rem] sm:h-[8rem] h-[3rem] relative rounded-full bg-[var(--dm-glow-color)] sm:shadow-[0_0_140px_130px_var(--dm-glow-color)] shadow-[0_0_90px_70px_var(--dm-glow-color)]' : 'glow-fade-in sm:w-[8rem] w-[3rem] sm:h-[8rem] h-[3rem] absolute sm:mr-44 mr-24 sm:mb-48 mb-32 rounded-full bg-[var(--lm-glow-color)] sm:shadow-[0_0_140px_130px_var(--lm-glow-color)] shadow-[0_0_90px_70px_var(--lm-glow-color)]'}
                                    ></div>
                                    <img className={currentTheme === 'dark' ? "fade-in sm:h-[24rem] h-[12rem] z-10 sm:mr-6 mr-2 absolute bottom-0 right-0" : "fade-in sm:h-[24rem] h-[12rem] z-10 sm:mr-5 mr-2"}
                                        src={portraitSource} alt="PortraitDarkmode" />
                                </>
                            }

                            {currentTheme === 'dark' ? <img className={`${drawingIsVisible && contactVisitedDark === 0 ? "drawing-animation sm:h-[24rem] sm:w-[27.3rem] h-[12rem] w-[13.7rem] z-20 absolute bottom-0 right-0" : "opacity-50 sm:h-[24rem] sm:w-[27.3rem] h-[12rem] w-[13.7rem] z-20 absolute bottom-0 right-2"}`} src={`${drawingIsVisible ? drawingSource : ""}`} />
                                : <img className={`${drawingIsVisible && contactVisitedLight === 0 ? "drawing-animation sm:h-[24.3rem] sm:w-[29.9rem] h-[12rem] w-[14.8rem] z-20 absolute bottom-0 right-0" : "opacity-50 sm:h-[24.3rem] sm:w-[29.9rem] h-[12rem] w-[14.8rem] z-20 absolute bottom-0 right-0"}`} src={`${drawingIsVisible ? drawingSource : ""}`} />}
                        </div> */}
                </div>
            </section>
        </>
