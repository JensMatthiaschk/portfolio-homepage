            ...
            <section id="Contact" className="flex flex-col lg:mx-10 mt-20 pt-10">
                ...
                <div className="flex items-end justify-between">
                            ...
                            <ul className={(currentTheme === 'dark' && contactVisitedDark === 0) || (currentTheme === 'light' && contactVisitedLight === 0) ? "linkButton-fade-in-animation flex flex-col md:flex-row sm:flex-wrap gap-4 sm:gap-6 items-center sm:pl-16 pl-14 z-30" : "fade-in flex flex-col md:flex-row sm:flex-wrap gap-4 sm:gap-6 items-start sm:pl-16 pl-14 z-30"}>
                                ...
                                <li>
                                    <a href="http://www.linkedin.com/in/jensmatthiaschk"
                                        target="_newBrowserTab"
                                        rel="noopener">
                                        <svg className={currentTheme === 'dark' ? "bi bi-linkedin w-12 sm:w-14 hover:w-14 hover:sm:w-16 hover:-m-1 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_10px_#275e74]  transform-gpu" : "bi bi-linkedin w-12 sm:w-14 hover:sm:w-16 hover:w-14 hover:-m-1 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_7px_var(--lm-third-color)] transform-gpu"}
                                            viewBox="0 0 48 48"
                                            fill="currentColor"
                                ...
                                <li>
                                    <label htmlFor="emailModal">
                                        <svg version="1.1"
                                            id="Capa_1"
                                            className={currentTheme === 'dark' ? "bi bi-envelope-fill w-12 sm:w-14 hover:w-14 hover:sm:w-16 hover:-m-1 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_10px_#275e74] transform-gpu" : "bi bi-envelope-fill w-12 sm:w-14 hover:sm:w-16 hover:w-14 hover:-m-1 ease-in-out delay-100 duration-300 hover:drop-shadow-[0_0_7px_var(--lm-third-color)] transform-gpu"}
                                            xmlns="http://www.w3.org/2000/svg"
					...
					V23c0-1.104,0.896-2,2-2h28c1.104,0,2,0.896,2,2V41z"/>
                                ...
                                <li className={currentTheme === 'dark' ? "hover:drop-shadow-[0_0_10px_#275e74] w-12 sm:w-14 hover:w-14 hover:sm:w-16 hover:-m-1 ease-in-out delay-100 duration-300 transform-gpu" : "hover:drop-shadow-[0_0_7px_var(--lm-third-color)] w-12 sm:w-14 hover:sm:w-16 hover:w-14 hover:-m-1 ease-in-out delay-100 duration-300 transform-gpu"}>
